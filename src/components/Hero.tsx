  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32 pt-40">
        ...
        {/* Claude callout */}
        <div className="inline-flex flex-col sm:flex-row items-center gap-3 bg-violet-950/40 border border-violet-800/40 rounded-2xl px-6 py-4 mb-10 text-sm text-gray-300">
          <div className="flex items-center gap-2">
            <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 text-violet-400 shrink-0" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" />
            </svg>
            <span><span className="text-violet-300 font-semibold">Claude API</span> · <span className="text-violet-300 font-semibold">Claude Code</span> · <span className="text-violet-300 font-semibold">Anthropic SDK</span></span>
          </div>
